...
def main():
    ...
    for epoch in range(args.num_train_epochs):
        ...
        print_rank_0(
            ...
            args.global_rank)
        train_reward_score, train_acc = evaluation_reward(rm_model, train_dataloader)
        print_rank_0(
            f"train_chosen_last_scores (higher is better) : {train_reward_score}, train_acc (higher is better) : {train_acc}",
            args.global_rank)
        reward_score, acc = evaluation_reward(rm_model, eval_dataloader)
        print_rank_0(
            f"chosen_last_scores (higher is better) : {reward_score}, acc (higher is better) : {acc}",
